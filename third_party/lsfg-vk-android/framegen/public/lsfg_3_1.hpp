...
namespace LSFG_3_1 {
    ...
    /// Update temporal features without generating output images. No external
    /// semaphores are used; the caller must waitIdle() before reusing inputs.
    __attribute__((visibility("default")))
    void advanceContext(int32_t id);
