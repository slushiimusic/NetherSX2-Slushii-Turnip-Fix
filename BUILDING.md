...
```bash
VARIANT=FRAMEGEN VERSION_CODE=26500723 bash build-nova-thor.sh /path/to/Pink-base.apk
VARIANT=NONFRAMEGEN VERSION_CODE=26500723 bash build-nova-thor.sh /path/to/Pink-base.apk
